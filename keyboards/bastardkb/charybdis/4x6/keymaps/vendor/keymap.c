...
#define LT_LP_KC_Z LT(LAYER_POINTER, KC_Z)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
    ...
    KC_LSFT,        LT_LP_KC_Z,         KC_X,               KC_C,               KC_V,               KC_B,                           KC_N,                   KC_M,                   KC_COMMA,           KC_DOT,             LT_LP_KC_SLASH,        KC_LSFT,
                                                            KC_BTN1,            KC_SPACE,           KC_DELETE,                      LT(LAYER_FUN, KC_BSPC), LT(LAYER_NAV, KC_ENTER),
